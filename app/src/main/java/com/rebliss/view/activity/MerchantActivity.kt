...
import kotlinx.android.synthetic.main.activity_merchant.icBack
import kotlinx.android.synthetic.main.address_merchant.*
import kotlinx.android.synthetic.main.assignments.*
import kotlinx.android.synthetic.main.assignments.btnUploadGstPic
import kotlinx.android.synthetic.main.assignments.btnUploadPanPic
import kotlinx.android.synthetic.main.assignments.etGstNumber
import kotlinx.android.synthetic.main.assignments.etPanNumber
import kotlinx.android.synthetic.main.assignments.fssaiCheckBox
import kotlinx.android.synthetic.main.assignments.gstContainer
import kotlinx.android.synthetic.main.assignments.imgCameraGst
import kotlinx.android.synthetic.main.assignments.imgCameraPan
import kotlinx.android.synthetic.main.assignments.imgGalleryGst
import kotlinx.android.synthetic.main.assignments.imgGalleryPan
import kotlinx.android.synthetic.main.assignments.otherActivityCheckBox
import kotlinx.android.synthetic.main.assignments.otherActivityCheckBoxPan
import kotlinx.android.synthetic.main.assignments.panContainer
import kotlinx.android.synthetic.main.assignments.tradelicenseCheckBox
import kotlinx.android.synthetic.main.assignments.udyogaadhaarCheckBox
        ...
        btnAssignments.setOnClickListener {
            ...
            if (!imgdone.isVisible) {
                ...
                var shopsID: String = etAirtelShopID.text.toString().trim { it <= ' ' }.plus(",")
                    ...
                    .plus(etPineLabsShopID.text.toString().trim { it <= ' ' })
                ...
                if (isAssignmentValidated(shopsID, orderId, shopGst, shopPan)) {
                    ...
                    if (etPineLabsShopID.text.toString().length > 0) {
                        checkValidationFromApi(etPineLabsShopID.text.toString(), 1, shopsID, "66")
                    }
                    if (etJioShopID.text.toString().length > 0) {
...
// save kyc button
        ...
        btnReview.setOnClickListener {
            ...
            shopsID = shopsID.removePrefix(",")
            if (isAssignmentValidated(shopsID, orderId, shopGst, shopPan))
                apiIntegrationforAssignment(shopsID, orderId, shopGst, shopPan)
...
//write the bytes in file
    ...
    fun checkValidationFromApi(storeId: String?, type: Int, shopsID: String, categoryid: String) {
        val apiService = ApiClient.getClient().create(ApiInterface::class.java)
